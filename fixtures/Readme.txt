...
2. From New Arrivals, retrieve all sub-menu items under Oasis and store in a List; Display the same
3. Login Page – At the down select login with password, there you find email and password. Enter invalid email and check whether it display error message and handle alerts.
(Suggested site: urbanladder.com  however you are free to use any other legitimate site)
